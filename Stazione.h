...
public:
    ...
    bool is_local();
    virtual bool present_train(bool) = 0;   //prende in input un bool (true andata, false ritorno) e dice se c'è almeno un binario occupato
    virtual int binario_occupato(bool)=0;
    virtual void change_status(bool, int) = 0;
    Stazione(Stazione&) = delete;
    Stazione operator=(Stazione&)const = delete;
protected:
